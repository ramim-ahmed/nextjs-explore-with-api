const productDetails = ({product}) => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-fit object-center rounded" src={image}/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex mb-4">
          <span className="flex items-center">
            ...
            <span className="text-gray-600 ml-3">{rating.rate} Reviews</span>
          </span>
...
export async function getStaticPaths() {
    ...
    const prducts = await res.json()
  
    // Get the paths we want to pre-render based on posts
    const paths = prducts.map((product) => ({
